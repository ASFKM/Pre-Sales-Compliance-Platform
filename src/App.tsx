    ...
    <div className="flex flex-col h-screen w-full bg-[#f8fafc] text-slate-900 font-sans overflow-hidden">
      ...
      <nav className="h-14 bg-slate-900 text-white flex items-center justify-between px-6 shrink-0 z-10 shadow-md">
        <div className="flex items-center gap-4">
          <div className="w-9 h-9 bg-emerald-500 rounded flex items-center justify-center font-bold text-slate-900 shadow-sm">
            CA
          </div>
          ...
          {activeTab === "admin" && (
            <div className="flex-1 p-6 overflow-y-auto space-y-8">
              ...
              <div className="flex justify-between items-center bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                <div>
                  <h2 className="text-lg font-bold text-slate-900 flex items-center gap-1.5">
                    {locale === "pt" ? "Console de Administração" : "Enterprise Administration Panel"}
                    <HelpTooltip content={t("adminHelp")} />
                  </h2>
                  <p className="text-xs text-slate-500 font-sans mt-0.5">
                    {locale === "pt" ? "Configure chaves de API, segurança do debug console, licenciamento de uso, integrações ERP/CRM, custos de tokens e prompts do sistema." : "Configure API keys, debug console security, usage licensing, ERP/CRM integrations, token costs and system prompts."}
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-xs bg-emerald-100 text-emerald-800 font-mono font-bold px-2 py-1 rounded">
                    {locale === "pt" ? "Nível: Super Admin" : "Level: Super Admin"}
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-8">
                ...
                <div className="space-y-4 bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                  <div className="flex items-center gap-1">
                    <h3 className="text-sm font-bold uppercase tracking-wider font-mono text-slate-800">
                      {locale === "pt" ? "Modelos de Destino & IA" : "System & AI Target Models Setup"}
                    </h3>
                  ...
                  {/* Active AI Providers (ChatGPT, Anthropic Claude, DeepSeek API Keys setup) */}
                            ...
                            <div className="grid grid-cols-2 gap-2 mt-1">
                              <div>
                                ...
                                <input
                                  ...
                                  className="w-full p-1.5 text-[11px] font-mono bg-white border border-slate-200 rounded focus:ring-1 focus:ring-emerald-500"
                                />
                              </div>
                              <div>
                                <label className="text-[9px] uppercase font-bold text-slate-400 font-mono block mb-0.5">
                ...
                {/* API CRM / ERP Integrations (Removed) */}
                <div className="hidden space-y-4 bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                  <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                    <h3 className="text-sm font-bold uppercase tracking-wider font-mono text-slate-800">
                      {locale === "pt" ? "Conectores Corporativos de Pré-Vendas" : "Pre-Sales Enterprise Connectors"}
                    </h3>
                    <button
                      onClick={() => {
                  ...
                  {/* FORM TO ADD NEW CRM CONNECTOR */}
                  {showNewConnectorForm && (
                    <div className="p-4 bg-slate-50 border border-emerald-500/30 rounded-lg space-y-3 transition-all">
                      ...
                      <div className="grid grid-cols-2 gap-3 text-xs">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full p-2 bg-white border border-slate-200 rounded focus:ring-1 focus:ring-emerald-500 focus:outline-none"
                          />
                        </div>
                        <div>
                          <label className="text-[9px] uppercase font-bold text-slate-400 font-mono block mb-1">
                          ...
                          <select
                            ...
                            className="w-full p-2 bg-white border border-slate-200 rounded focus:ring-1 focus:ring-emerald-500 focus:outline-none cursor-pointer"
                          >
                        ...
                        <div className="col-span-2">
                          ...
                          <input
                            ...
                            className="w-full p-2 bg-white border border-slate-200 rounded focus:ring-1 focus:ring-emerald-500 focus:outline-none font-mono"
                          />
                        </div>
                        <div className="col-span-2">
                          <label className="text-[9px] uppercase font-bold text-slate-400 font-mono block mb-1">
                          ...
                          <input
                            ...
                            onChange={(e) => setNewConnectorToken(e.target.value)}
                            className="w-full p-2 bg-white border border-slate-200 rounded focus:ring-1 focus:ring-emerald-500 focus:outline-none font-mono"
                          />
                        </div>
                      </div>
                      <div className="flex justify-end gap-2 pt-2">
                        <button
                          type="button"
                          onClick={() => setShowNewConnectorForm(false)}
                          className="bg-slate-200 hover:bg-slate-300 text-slate-700 font-mono text-[10px] font-bold py-1.5 px-3 rounded cursor-pointer"
                        >
                          {locale === "pt" ? "Cancelar" : "Cancel"}
                        </button>
                        <button
                          ...
                          className="bg-emerald-600 hover:bg-emerald-700 text-white font-mono text-[10px] font-bold py-1.5 px-3 rounded shadow cursor-pointer"
                        >
                  ...
                  <div className="space-y-4">
                    {integrations.length === 0 ? (
                      <div className="text-center py-6 text-xs text-slate-400 italic">
                        {locale === "pt" ? "Nenhum conector de CRM/ERP configurado ainda." : "No CRM/ERP connectors configured yet."}
                      </div>
                    ) : (
                      integrations.map((conn, cIdx) => (
                        <div key={conn.id} className="p-4 bg-slate-50 rounded-lg border border-slate-100 space-y-3 relative group">
                          ...
                          <button
                            ...
                            className="absolute top-4 right-4 text-slate-400 hover:text-red-600 cursor-pointer p-1 rounded hover:bg-slate-200/50 transition-all opacity-0 group-hover:opacity-100"
                            title={locale === "pt" ? "Excluir Conector" : "Delete Connector"}
                          >
                            <Trash2 size={14} />
                          </button>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <span className={`text-[9px] font-bold px-2 py-0.5 rounded uppercase shrink-0 ${
                              conn.status === "connected" ? "bg-emerald-100 text-emerald-800" : (conn.status === "error" ? "bg-red-100 text-red-800" : "bg-slate-200 text-slate-500")
                            }`}>{conn.status}</span>
                          </div>

                          {/* Interactive fields to configure integration */}
                          <div className="grid grid-cols-2 gap-2 text-xs">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  const updated = [...integrations];
                                  updated[cIdx].token = e.target.value;
                                  setIntegrations(updated);
                                }}
                                className="w-full p-1.5 text-[11px] font-mono bg-white border border-slate-200 rounded focus:ring-1 focus:ring-emerald-500"
                              />
                          ...
                          {conn.error_message && (
                            <p className="text-[9px] text-red-500 font-mono italic">Error: {conn.error_message}</p>
                          )}
                          ...
                          <div className="flex justify-end gap-2 pt-1 border-t border-slate-200/50">
                            <button
                              ...
                              className="bg-slate-200 hover:bg-slate-300 text-slate-700 font-mono text-[9px] font-bold py-1 px-2.5 rounded shadow-xs transition-all cursor-pointer"
                            >
                              {locale === "pt" ? "Salvar Conector" : "Save Connector"}
                            </button>
                            <button
                            ...
                            >
                              {locale === "pt" ? "Testar Conexão" : "Test Connector"}
                            </button>
                          </div>
                        </div>
                      ))
              ...
              <div className="grid grid-cols-2 gap-8 pt-4 border-t border-slate-200">
                ...
                <div className="space-y-4 bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                  <div className="flex items-center gap-1">
                    <h3 className="text-sm font-bold uppercase tracking-wider font-mono text-slate-800">
                      {locale === "pt" ? "Gestão de Subscrição & Licença" : "Subscription & Licensing Manager"}
                    </h3>
                    <HelpTooltip content={t("licenseHelp")} />
                  </div>
                  ...
                  <div className="space-y-3 text-xs leading-normal">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="p-3 bg-slate-50 border border-slate-100 rounded-lg">
                        ...
                        <span className="text-sm font-extrabold text-emerald-600 font-mono flex items-center gap-1.5 mt-1">
                    ...
                    <div className="p-3 bg-emerald-50/50 border border-emerald-100 rounded-lg space-y-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="bg-emerald-600 hover:bg-emerald-700 text-white font-mono text-[10px] font-bold px-3 py-1.5 rounded shadow-sm transition-all cursor-pointer"
                        >
                          {locale === "pt" ? "Ativar" : "Activate"}
                        </button>
                      </div>
                      {licenseMessage && (
                        <p className="text-[10px] font-semibold text-emerald-700 font-mono animate-pulse mt-1">{licenseMessage}</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                  <div className="flex items-center gap-1">
                    <h3 className="text-sm font-bold uppercase tracking-wider font-mono text-slate-800">
                      {locale === "pt" ? "Gestor de Custo de Uso da API" : "API Token Usage Cost Tracker"}
                    </h3>
                    <HelpTooltip content={t("costHelp")} />
                  </div>
                  ...
                  <div className="space-y-3 text-xs leading-normal font-mono">
                    ...
                    <div className="space-y-2 pt-2 text-[11px] text-slate-600">
                      <div className="flex justify-between">
                        <span>{locale === "pt" ? "Tokens de Entrada:" : "Input Tokens:"}</span>
                        <span className="font-bold text-slate-800">{inputTokens.toLocaleString()} tokens</span>
                      </div>
                      <div className="flex justify-between">
                        <span>{locale === "pt" ? "Tokens de Saída:" : "Output Tokens:"}</span>
                        <span className="font-bold text-slate-800">{outputTokens.toLocaleString()} tokens</span>
                      </div>
                      <div className="flex justify-between">
                        <span>{locale === "pt" ? "Câmbio Comercial:" : "Exchange Rate:"}</span>
                        <span className="font-bold text-slate-500">1 USD = R$ {exchangeRate.toFixed(2)} BRL</span>
                      </div>
                    </div>

                    <div className="p-3 bg-slate-50 border border-slate-100 rounded-lg space-y-2 mt-2">
                      <span className="text-[9px] uppercase font-bold text-slate-400 block">
                        {locale === "pt" ? "Simular Consumo Manual" : "Simulate Manual Token Intake"}
                      </span>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              setInputTokens(val);
                              setCostUSD((val * 0.0000025) + (outputTokens * 0.00001));
                            }}
                            className="w-full p-1 bg-white border border-slate-200 rounded text-xs animate-pulse"
                          />
                        </div>
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              const val = Number(e.target.value);
                              setOutputTokens(val);
                              setCostUSD((inputTokens * 0.0000025) + (val * 0.00001));
                            }}
                            className="w-full p-1 bg-white border border-slate-200 rounded text-xs animate-pulse"
                          />
                        </div>
